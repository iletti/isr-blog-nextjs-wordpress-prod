...
export default function Footer() {
  ...
  useEffect(() => {
    ...
    const whatsappLink = 'https://wa.me/358456002505?text=Moi%20Ilari%2C%20ymm%C3%A4rsin%2C%20ett%C3%A4%20voisit%20auttaa%20minua%20saavuttamaan%20online%20n%C3%A4kyvyytt%C3%A4%20yritykselleni.%20%3A%29';
  ...
  return (
    ...
    <a href="/" className="link link-hover">Etusivu</a>
    <a href="/palvelut"  className="link link-hover">Palvelut</a>
    <a href="/#blogi"  className="link link-hover">Blogi</a>
    <a  href="/tietoa" className="link link-hover">Tietoa</a>
  </nav> 
  <nav>
