    ...
    <Layout preview={preview}>
      ...
      <div className="hero  bg-[url('https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg')]" style={{backgroundPosition: 'center'}}>
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5">  Morjes! Nimeni on Ilari Schmidt. Aloitin matkani digimarkkinoinnin parissa 2014. Plakkarissa alkaa olemaan jo iso kasa kokemusta ja toteutettuja Google Ads kampanjoita kohta jo yli 10 vuoden kokemuksella.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-100 py-10">
        <div className="container mx-auto px-4">
          <div className="mb-10">
            <h2 className="text-center text-4xl font-bold text-gray-800 mb-6">Ammatillista taustatietoa</h2>
...
Yli kymmenen vuoden kokemuksella digitaalisessa markkinoinnissa erikoisosaamiseni keskittyy luomaan ja hallinnoimaan tuloksellisia Google Ads -kampanjoita. Sertifioituna Google Ads -asiantuntijana olen auttanut useita yrityksiä saavuttamaan täyden potentiaalinsa verkossa. Olipa kyseessä sitten bränditietoisuuden lisääminen tai myynnin kasvattaminen, strateginen lähestymistapani räätälöidään vastaamaan yrityksesi ainutlaatuisia tavoitteita.</p>
            </div>
          </div>

          <div className="my-16">
            <h2 className="text-center text-4xl font-bold text-gray-800 mb-6">Osaaminen</h2>
          ...
          <div className="text-center">
            <h3 className="text-3xl font-bold text-gray-800 mb-6">Jutellaanko?</h3>
            <p className="text-xl text-gray-600 mb-6">Haluatko tietää lisää siitä, miten voimme tehdä yhteistyötä? Ota yhteyttä, niin keskustellaan yrityksesi tavoitteista ja siitä, miten voin tukea kasvuasi Google Ads -palvelun avulla.</p>
